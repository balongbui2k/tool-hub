...
function PdfPageRender({ pageNum, pdfDoc, scale, signatures, selectedId, setSelectedId, setSignatures }: any) {
...
function DraggableSignature({ sig, isSelected, onClick, onUpdate, scale }: any) {
